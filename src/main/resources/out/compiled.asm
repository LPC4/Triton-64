    ; Program entry point
_start:
    ; Allocating space for 11 global variables
    ...
    ; Allocated global variable 'test_ptr1' at GP+48
    ; Allocated global variable 'test_ptr2' at GP+56
    ; Allocated global variable 'test_ptr3' at GP+64
    ; Allocated global variable 'test_ptr4' at GP+72
    ; Allocated global variable 'test_ptr5' at GP+80
    LDI t0, 88
    ADD hp, gp, t0
    ; Heap pointer set to SP + 88 for global variables
    ...
    ADD t1, gp, t1
    ST t1, t0
    ; Initializing global 'test_ptr1'
    LDI t0, 0
    LDI t1, 48
    ADD t1, gp, t1
    ST t1, t0
    ; Initializing global 'test_ptr2'
    LDI t0, 0
    LDI t1, 56
    ADD t1, gp, t1
    ST t1, t0
    ; Initializing global 'test_ptr3'
    LDI t0, 0
    LDI t1, 64
    ADD t1, gp, t1
    ST t1, t0
    ; Initializing global 'test_ptr4'
    LDI t0, 0
    LDI t1, 72
    ADD t1, gp, t1
    ST t1, t0
    ; Initializing global 'test_ptr5'
    LDI t0, 0
    LDI t1, 80
    ADD t1, gp, t1
    ST t1, t0
...
test_basic_allocation:
    ...
    ; Cleaned up 1 arguments from stack
    MOV t0, a0
    ; Assignment to global variable: test_ptr1
    LDI t1, 48
    ADD t1, gp, t1
    ST t1, t0
    LDI t1, 48
    ...
    ; Cleaned up 1 arguments from stack
    MOV t0, a0
    ; Assignment to global variable: test_ptr2
    LDI t1, 56
    ADD t1, gp, t1
    ST t1, t0
    LDI t1, 56
    ...
    ; Cleaned up 1 arguments from stack
    MOV t0, a0
    ; Assignment to global variable: test_ptr3
    LDI t1, 64
    ADD t1, gp, t1
    ST t1, t0
    LDI t1, 64
    ...
    LDI t1, 24
    ADD t2, t0, t1
    LDI t0, 8608480567731124087
    ; Assignment to dereferenced address at t2
    ST t2, t0
    ; Function epilogue
test_basic_allocation_end_74:
    POP fp
    POP ra
    JMP ra                               ; Return from test_basic_allocation

    ; =====================
    ; Function: test_free_and_realloc
    ; =====================
test_free_and_realloc:
    ...
    ; Cleaned up 1 arguments from stack
    MOV t0, a0
    ; Assignment to global variable: test_ptr4
    LDI t1, 72
    ADD t1, gp, t1
    ST t1, t0
    LDI t1, 72
    ...
    ; Cleaned up 1 arguments from stack
    MOV t0, a0
    ; Assignment to global variable: test_ptr5
    LDI t1, 80
    ADD t1, gp, t1
    ST t1, t0
    LDI t1, 80
    ...
    LDI t1, 56
    ADD t2, t0, t1
    LDI t0, 1076060070966390510
    ; Assignment to dereferenced address at t2
    ST t2, t0
    ; Function epilogue
test_free_and_realloc_end_75:
    POP fp
    POP ra
    JMP ra                               ; Return from test_free_and_realloc
...
test_edge_cases:
    ...
    ADD t0, fp, t0
    LD t1, t0
    LDI t0, 691752902764108185
    ; Assignment to dereferenced address at t1
    ST t1, t0
    ; Function call: realloc
    ; Preparing function call: realloc
    ; Evaluating argument 0
    LDI t0, -24
    ADD t0, fp, t0
    LD t1, t0
    ...
    ; Cleaned up 2 arguments from stack
    MOV t0, a0
    ; Assignment to local variable: ptr_realloc
    LDI t1, -24
    ADD t1, fp, t1
    ST t1, t0
    ; Binary operation: ADD
    ...
    LD t1, t0
    MOV a0, t1
    JMP test_edge_cases_end_76
    ; Function epilogue
test_edge_cases_end_76:
    LDI t0, 48
    ADD sp, sp, t0
    ; Deallocated 48 bytes for frame
    POP fp
    POP ra
    JMP ra                               ; Return from test_edge_cases

    ; ===========================
    ; Function: test_heap_stats
    ; ===========================
test_heap_stats:
    ; Function prologue
    PUSH ra
    ...
    ADD t1, fp, t1
    ST t1, t0
    ; Declaration: total_allocated_addr
    ; Function call: malloc
    ; Preparing function call: malloc
    ; Evaluating argument 0
    LDI t0, 8
    ...
    ST t1, t0
    ; Expression statement
    ; Function call: get_heap_stats
    ; Preparing function call: get_heap_stats
    ; Evaluating argument 0
    LDI t0, -8
    ADD t0, fp, t0
    LD t1, t0
    ...
    PUSH t2
    PUSH t1
    JAL get_heap_stats, ra
    LDI t0, 24
    ADD sp, sp, t0
    ; Cleaned up 3 arguments from stack
    MOV t0, a0
    ; Declaration: stats_free
    LDI t0, -8
    ADD t0, fp, t0
    LD t1, t0
    LD t0, t1
    ...
    LD t1, t0
    MOV a0, t1
    JMP test_heap_stats_end_77
    ; Function epilogue
test_heap_stats_end_77:
    LDI t0, 48
    ADD sp, sp, t0
    ; Deallocated 48 bytes for frame
    POP fp
    POP ra
    JMP ra                               ; Return from test_heap_stats
...
main:
    ...
    ; Allocated 48 bytes for 6 local variables
    ; Expression statement
    ; Function call: test_basic_allocation
    ; Preparing function call: test_basic_allocation
    JAL test_basic_allocation, ra
    MOV t0, a0
    ; Declaration: separator1
    LDI t0, 1075791652417552111
    LDI t1, -8
    ADD t1, fp, t1
    ST t1, t0
    ; Expression statement
    ; Function call: test_free_and_realloc
    ; Preparing function call: test_free_and_realloc
    JAL test_free_and_realloc, ra
    MOV t0, a0
    ; Declaration: separator2
    LDI t0, 792275913406267614
    LDI t1, -16
    ADD t1, fp, t1
    ST t1, t0
    ; Declaration: final_ptr
    ; Function call: test_edge_cases
    ; Preparing function call: test_edge_cases
    JAL test_edge_cases, ra
    MOV t0, a0
    LDI t1, -24
    ADD t1, fp, t1
    ST t1, t0
    ; Declaration: separator3
    LDI t0, 1057711424614087358
    LDI t1, -32
    ADD t1, fp, t1
    ST t1, t0
    ; Declaration: heap_stats
    ; Function call: test_heap_stats
    ; Preparing function call: test_heap_stats
    JAL test_heap_stats, ra
    MOV t0, a0
    LDI t1, -40
    ADD t1, fp, t1
    ST t1, t0
    ; Declaration: test_complete
    LDI t0, 158846962688052719
    LDI t1, -48
    ADD t1, fp, t1
    ST t1, t0
    ; While loop
